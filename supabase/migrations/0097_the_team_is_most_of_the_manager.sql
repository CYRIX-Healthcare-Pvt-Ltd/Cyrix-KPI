-- =====================================================================
-- Cyrix KPI  ·  0097  ·  The team a manager builds is most of their score
--
-- 0096 weighted a manager 10 submission TAT / 30 completion TAT / 60 team
-- band. Management's revision after seeing it: the two turnaround figures
-- together should cap at 30, and the team's own standing should carry the
-- other 70 -- so that a manager with a strong team is a strong manager,
-- and promptness is the smaller half of the job rather than most of it.
--
--   Manager   (0.1 x team submission TAT
--            + 0.2 x manager completion TAT
--            + 0.7 x the team's average band)
--            x the share of the team's year actually scored
--
-- The coverage multiplier stays and is the load-bearing part. Without it
-- a manager who had scored one of eighty-one months came first, because
-- every other component was computed from that single month. Weighting
-- cannot fix that; only multiplying by how much has been done can.
--
-- This is 0096's function with three weights changed and nothing else
-- touched -- taken from the live definition rather than retyped, for the
-- same reason 0095 says.
-- =====================================================================
