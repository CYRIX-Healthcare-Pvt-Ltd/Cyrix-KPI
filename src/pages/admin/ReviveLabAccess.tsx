 ...
 *
 * THIS FILE IS SHARED. It is a copy of Revive Lab's own People & Revive
 * Labs page (Cyrix-Revive-Lab: src/pages/Access.tsx), shown here as SW
 * Admin's "Revive Lab" tab. It depends on nothing but the Supabase client
 * and the four ui pieces both apps have. Change it in one, copy it to the
 * other.
 *
