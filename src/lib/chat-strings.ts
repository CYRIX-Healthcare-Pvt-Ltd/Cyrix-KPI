...
export const CHAT: Record<string, Phrase> = {
  ...
  */
  ...
  'tip.photo': {
    en: 'you can put a photo on your profile? It shows up wherever your name does, so you are a face rather than a code.',
    ml: 'നിങ്ങളുടെ പ്രൊഫൈലിൽ ഒരു ഫോട്ടോ ചേർക്കാം? നിങ്ങളുടെ പേര് വരുന്നിടത്തെല്ലാം അത് കാണും, അപ്പോൾ നിങ്ങൾ ഒരു കോഡല്ല, ഒരു മുഖമാണ്.',
    hi: 'आप अपनी प्रोफ़ाइल पर फ़ोटो लगा सकते हैं? जहाँ भी आपका नाम आता है वहाँ वह दिखती है — आप कोड नहीं, एक चेहरा होते हैं।',
    te: 'మీ ప్రొఫైల్‌కు ఫోటో పెట్టవచ్చు? మీ పేరు కనిపించే ప్రతిచోటా అది కనిపిస్తుంది — మీరు కోడ్ కాదు, ఒక ముఖం.',
    ta: 'உங்கள் சுயவிவரத்தில் புகைப்படம் சேர்க்கலாம்? உங்கள் பெயர் வரும் இடமெல்லாம் அது தெரியும் — நீங்கள் ஒரு குறியீடு அல்ல, ஒரு முகம்.',
  },
  'tip.rank': {
    en: 'you can see where you stand in your team? It is under your name on your profile. Nobody sees anybody else\'s score, just your own position.',
    ml: 'ടീമിൽ നിങ്ങൾ എവിടെ നിൽക്കുന്നു എന്ന് കാണാം? പ്രൊഫൈലിൽ നിങ്ങളുടെ പേരിന് താഴെയുണ്ട്. മറ്റാരുടെയും സ്കോർ ആരും കാണില്ല, നിങ്ങളുടെ സ്ഥാനം മാത്രം.',
    hi: 'आप देख सकते हैं कि टीम में आप कहाँ खड़े हैं? यह प्रोफ़ाइल पर आपके नाम के नीचे है। किसी को किसी और का स्कोर नहीं दिखता, बस आपकी अपनी जगह।',
    te: 'టీమ్‌లో మీరు ఎక్కడ ఉన్నారో చూడవచ్చు? అది ప్రొఫైల్‌లో మీ పేరు కింద ఉంటుంది. ఎవరికీ ఇతరుల స్కోరు కనిపించదు, మీ స్థానం మాత్రమే.',
    ta: 'குழுவில் நீங்கள் எங்கே இருக்கிறீர்கள் என்று பார்க்கலாம்? அது சுயவிவரத்தில் உங்கள் பெயருக்குக் கீழே உள்ளது. யாருக்கும் மற்றவரின் மதிப்பெண் தெரியாது, உங்கள் இடம் மட்டும்.',
  },
  'tip.language': {
  ...
  'tip.manual': {
    en: 'the whole manual is one page, in your language? Plain answers, no difficult words — and it only shows what your own login can do.',
    ml: 'മുഴുവൻ മാനുവലും നിങ്ങളുടെ ഭാഷയിൽ ഒരൊറ്റ പേജിലാണ്? ലളിതമായ ഉത്തരങ്ങൾ, സാങ്കേതിക പദങ്ങളില്ല — നിങ്ങളുടെ ലോഗിന് ചെയ്യാനാകുന്നത് മാത്രം കാണിക്കും.',
    hi: 'पूरा मैनुअल आपकी भाषा में एक ही पेज पर है? सीधे जवाब, कोई तकनीकी भाषा नहीं — और उसमें सिर्फ़ वही है जो आपका लॉगिन कर सकता है।',
    te: 'మొత్తం మాన్యువల్ మీ భాషలో ఒకే పేజీలో ఉంది? సూటి సమాధానాలు, సాంకేతిక పదాలు లేవు — మీ లాగిన్ చేయగలిగేవి మాత్రమే చూపిస్తుంది.',
    ta: 'முழு கையேடும் உங்கள் மொழியில் ஒரே பக்கத்தில் உள்ளது? நேரடி பதில்கள், தொழில்நுட்பச் சொற்கள் இல்லை — உங்கள் லாகின் செய்யக்கூடியவை மட்டுமே காட்டப்படும்.',
  },
  'tip.videos': {
    en: 'the manual has 4 short videos? Together they show a KPI year: setting up a KPI, approving it, filling in a month and scoring it. They are at the top, and each plays right there on the page.',
    ml: 'മാനുവലിൽ 4 ചെറിയ വീഡിയോകളുണ്ട്? ഒരുമിച്ച് അവ ഒരു KPI വർഷം കാണിക്കുന്നു: ഒരു KPI സജ്ജമാക്കുന്നത്, അത് അംഗീകരിക്കുന്നത്, ഒരു മാസം പൂരിപ്പിക്കുന്നത്, അതിന് സ്കോർ നൽകുന്നത്. അവ മുകളിലുണ്ട്, ഓരോന്നും ആ പേജിൽ തന്നെ പ്ലേ ആകും.',
    hi: 'मैनुअल में 4 छोटे वीडियो हैं? साथ मिलकर वे एक KPI साल दिखाते हैं: KPI सेट करना, उसे मंज़ूर करना, महीना भरना और उसे स्कोर करना। वे सबसे ऊपर हैं, और हर वीडियो उसी पेज पर चलता है।',
    te: 'మాన్యువల్‌లో 4 చిన్న వీడియోలు ఉన్నాయి? అవి కలిసి ఒక KPI సంవత్సరాన్ని చూపిస్తాయి: KPI సెట్ చేయడం, దాన్ని ఆమోదించడం, ఒక నెల నింపడం, దానికి స్కోర్ ఇవ్వడం. అవి పైభాగంలో ఉన్నాయి, ప్రతిదీ ఆ పేజీలోనే ప్లే అవుతుంది.',
    ta: 'கையேட்டில் 4 சிறிய வீடியோக்கள் உள்ளன? அவை சேர்ந்து ஒரு KPI ஆண்டைக் காட்டுகின்றன: KPI ஐ அமைப்பது, அதற்கு ஒப்புதல் அளிப்பது, ஒரு மாதத்தை நிரப்புவது, அதற்கு மதிப்பெண் அளிப்பது. அவை மேலே உள்ளன, ஒவ்வொன்றும் அந்தப் பக்கத்திலேயே இயங்கும்.',
  },
  'video.link': {
    en: 'Watch the video',
    ml: 'വീഡിയോ കാണുക',
  ...
  'tip.templates': {
    en: 'you can save a KPI as a template for your team? Your direct reports can start from it, or you can hand it to people with Assign to.',
    ml: 'ഒരു KPI നിങ്ങളുടെ ടീമിനായി template ആയി സേവ് ചെയ്യാം? നേരിട്ട് റിപ്പോർട്ട് ചെയ്യുന്നവർക്ക് അതിൽ നിന്ന് തുടങ്ങാം, അല്ലെങ്കിൽ Assign to ഉപയോഗിച്ച് നിങ്ങൾക്ക് അത് ആളുകൾക്ക് നൽകാം.',
    hi: 'आप किसी KPI को अपनी टीम के लिए template के रूप में सेव कर सकते हैं? सीधे रिपोर्ट करने वाले उससे शुरू कर सकते हैं, या आप Assign to से उसे लोगों को दे सकते हैं।',
    te: 'ఒక KPI ని మీ టీమ్ కోసం template గా సేవ్ చేయవచ్చు? నేరుగా రిపోర్ట్ చేసేవారు దాని నుండి మొదలుపెట్టవచ్చు, లేదా Assign to తో మీరే దాన్ని వ్యక్తులకు ఇవ్వవచ్చు.',
    ta: 'ஒரு KPI ஐ உங்கள் குழுவுக்கான template ஆகச் சேமிக்கலாம்? நேரடியாக அறிக்கை செய்பவர்கள் அதிலிருந்து தொடங்கலாம், அல்லது Assign to மூலம் நீங்களே அதை ஆட்களுக்கு வழங்கலாம்.',
  },
  'tip.analysis': {
  ...
  'tip.mgrrank': {
    en: 'managers get a standing of their own? How the team is doing, how promptly you score, and how promptly your team submits. Ask me "what is my rank".',
    ml: 'മാനേജർമാർക്ക് സ്വന്തമായി ഒരു റാങ്കിംഗ് ഉണ്ട്? ടീം എങ്ങനെ പ്രവർത്തിക്കുന്നു, നിങ്ങൾ എത്ര വേഗം സ്കോർ ചെയ്യുന്നു, നിങ്ങളുടെ ടീം എത്ര വേഗം സമർപ്പിക്കുന്നു എന്നിവ. എന്നോട് "what is my rank" എന്ന് ചോദിക്കൂ.',
    hi: 'मैनेजरों की अपनी एक रैंकिंग होती है? टीम कैसा कर रही है, आप कितनी जल्दी स्कोर करते हैं, और आपकी टीम कितनी जल्दी जमा करती है। मुझसे "what is my rank" पूछिए।',
    te: 'మేనేజర్లకు వారి సొంత ర్యాంకింగ్ ఉంటుంది? టీమ్ ఎలా ఉంది, మీరు ఎంత త్వరగా స్కోర్ చేస్తారు, మీ టీమ్ ఎంత త్వరగా సమర్పిస్తుంది అన్నవి. నన్ను "what is my rank" అని అడగండి.',
    ta: 'மேலாளர்களுக்கு அவர்களுக்கே உரிய தரவரிசை உண்டு? குழு எப்படிச் செயல்படுகிறது, நீங்கள் எவ்வளவு விரைவாக மதிப்பெண் அளிக்கிறீர்கள், உங்கள் குழு எவ்வளவு விரைவாகச் சமர்ப்பிக்கிறது என்பவை. என்னிடம் "what is my rank" என்று கேளுங்கள்.',
  },
  /*
  ...
  */
  ...
  'nudge.clear': {
    ...
    ml: 'ഹായ് {name} — ഇപ്പോൾ നിങ്ങൾക്ക് ബാക്കിയുള്ള ജോലി ഒന്നുമില്ല.',
    hi: 'नमस्ते {name} — अभी आपका कोई काम बाकी नहीं है।',
    te: 'హాయ్ {name} — ప్రస్తుతం మీకు పెండింగ్ పని ఏదీ లేదు.',
    ta: 'ஹாய் {name} — இப்போது உங்களுக்கு நிலுவையில் வேலை எதுவும் இல்லை.',
  },
  /*
  ...
  */
  'nudge.plancore': {
    en: 'Hey {name} — you have no pending work. Your lowest core value is {name2}, at {pct}%. How will you improve it?',
    ml: 'ഹായ് {name} — ബാക്കിയുള്ള ജോലി ഒന്നുമില്ല. നിങ്ങളുടെ ഏറ്റവും കുറഞ്ഞ കോർ വാല്യൂ {name2} ആണ്, {pct}%. ഇത് എങ്ങനെ മെച്ചപ്പെടുത്തും?',
    hi: 'नमस्ते {name} — कोई काम बाकी नहीं है। आपका सबसे कम कोर वैल्यू {name2} है, {pct}%। इसे कैसे सुधारेंगे?',
    te: 'హాయ్ {name} — పెండింగ్ పని ఏదీ లేదు. మీ అత్యల్ప కోర్ వాల్యూ {name2}, {pct}%. దీన్ని ఎలా మెరుగుపరుస్తారు?',
    ta: 'ஹாய் {name} — நிலுவையில் வேலை எதுவும் இல்லை. உங்கள் மிகக் குறைந்த கோர் வேல்யூ {name2}, {pct}%. இதை எப்படி மேம்படுத்துவீர்கள்?',
  },
  'nudge.planlever': {
    en: 'Hey {name} — you have no pending work. {kra} is the best area to work on now. If it reaches {target}%, your total score goes up by about {gain} marks.',
    ml: 'ഹായ് {name} — ബാക്കിയുള്ള ജോലി ഒന്നുമില്ല. ഇപ്പോൾ ശ്രദ്ധിക്കാൻ ഏറ്റവും നല്ലത് {kra} ആണ്. അത് {target}% എത്തിയാൽ നിങ്ങളുടെ ആകെ സ്കോർ ഏകദേശം {gain} മാർക്ക് കൂടും.',
    hi: 'नमस्ते {name} — कोई काम बाकी नहीं है। अभी काम करने के लिए सबसे अच्छा हिस्सा {kra} है। यह {target}% तक पहुँचे तो आपका कुल स्कोर लगभग {gain} अंक बढ़ेगा।',
    te: 'హాయ్ {name} — పెండింగ్ పని ఏదీ లేదు. ఇప్పుడు పని చేయడానికి ఉత్తమమైనది {kra}. అది {target}% చేరితే మీ మొత్తం స్కోరు సుమారు {gain} మార్కులు పెరుగుతుంది.',
    ta: 'ஹாய் {name} — நிலுவையில் வேலை எதுவும் இல்லை. இப்போது கவனம் செலுத்த சிறந்தது {kra}. அது {target}% அடைந்தால் உங்கள் மொத்த மதிப்பெண் சுமார் {gain} அதிகரிக்கும்.',
  },
  'nudge.planclimb': {
    en: 'Hey {name} — you have no pending work, and your score is going up: {soFar} for the year, {recent} in the last few months. Keep doing what you are doing.',
    ml: 'ഹായ് {name} — ബാക്കിയുള്ള ജോലി ഒന്നുമില്ല, നിങ്ങളുടെ സ്കോർ കൂടിവരുന്നു: വർഷത്തിൽ {soFar}, കഴിഞ്ഞ കുറച്ച് മാസങ്ങളിൽ {recent}. ഇതുപോലെ തുടരുക.',
    hi: 'नमस्ते {name} — कोई काम बाकी नहीं है, और आपका स्कोर बढ़ रहा है: साल में {soFar}, पिछले कुछ महीनों में {recent}। ऐसे ही करते रहिए।',
    te: 'హాయ్ {name} — పెండింగ్ పని ఏదీ లేదు, మీ స్కోరు పెరుగుతోంది: సంవత్సరంలో {soFar}, గత కొన్ని నెలల్లో {recent}. ఇలాగే కొనసాగించండి.',
    ta: 'ஹாய் {name} — நிலுவையில் வேலை எதுவும் இல்லை, உங்கள் மதிப்பெண் உயர்ந்து வருகிறது: ஆண்டில் {soFar}, கடந்த சில மாதங்களில் {recent}. இதேபோல் தொடருங்கள்.',
  },
  'nudge.newmonth': {
  ...
  */
  ...
  'stand.mgrdone': {
    en: 'You have scored {done} of the {due} months your team owes this year. Until a month is scored it counts for nothing — not in your standing, and not in theirs.',
    ml: 'ഈ വർഷം ടീം നൽകേണ്ട {due} മാസങ്ങളിൽ {done} എണ്ണം നിങ്ങൾ സ്കോർ ചെയ്തു. സ്കോർ ചെയ്യാത്ത ഒരു മാസം എവിടെയും കണക്കാക്കില്ല — നിങ്ങളുടെ റാങ്കിലുമില്ല, അവരുടെ റാങ്കിലുമില്ല.',
    hi: 'इस साल आपकी टीम के {due} महीनों में से {done} आपने स्कोर किए हैं। जब तक कोई महीना स्कोर नहीं होता, वह कहीं नहीं गिना जाता — न आपकी रैंकिंग में, न उनकी।',
    te: 'ఈ సంవత్సరం మీ టీమ్ ఇవ్వాల్సిన {due} నెలల్లో {done} మీరు స్కోర్ చేశారు. స్కోర్ చేయని నెల ఎక్కడా లెక్కలోకి రాదు — మీ ర్యాంకింగ్‌లోనూ కాదు, వారి ర్యాంకింగ్‌లోనూ కాదు.',
    ta: 'இந்த ஆண்டு உங்கள் குழு தர வேண்டிய {due} மாதங்களில் {done} மதிப்பெண் அளித்துள்ளீர்கள். மதிப்பெண் அளிக்காத மாதம் எங்கும் கணக்கில் வராது — உங்கள் தரவரிசையிலும் இல்லை, அவர்களுடையதிலும் இல்லை.',
  },
  'stand.mgrrank': {
  ...
  'stand.ranktop': {
    en: 'You are {rank} of {of} in your team this year — near the top. Hold it there.',
    ml: 'ഈ വർഷം ടീമിൽ നിങ്ങൾ {of}-ൽ {rank} ആണ് — മുൻനിരയ്ക്കടുത്ത്. അവിടെ നിലനിർത്തുക.',
    hi: 'इस साल टीम में आप {of} में से {rank} पर हैं — ऊपर के पास। इसे बनाए रखिए।',
    te: 'ఈ సంవత్సరం టీమ్‌లో మీరు {of}లో {rank} — పైభాగానికి దగ్గరగా. అలాగే నిలబెట్టుకోండి.',
    ta: 'இந்த ஆண்டு குழுவில் நீங்கள் {of}-இல் {rank} — மேல் இடங்களுக்கு அருகில். அதைத் தக்கவைத்துக் கொள்ளுங்கள்.',
  },
  'stand.ranklever': {
    en: 'You are {rank} of {of} in your team this year. {kra} is where the next marks are: at {target}% it adds about {gain}.',
    ml: 'ഈ വർഷം ടീമിൽ നിങ്ങൾ {of}-ൽ {rank} ആണ്. അടുത്ത മാർക്കുകൾ {kra}-യിലാണ്: {target}% എത്തിയാൽ ഏകദേശം {gain} കൂടും.',
    hi: 'इस साल टीम में आप {of} में से {rank} पर हैं। अगले अंक {kra} में हैं: {target}% पर यह लगभग {gain} बढ़ाता है।',
    te: 'ఈ సంవత్సరం టీమ్‌లో మీరు {of}లో {rank}. తర్వాతి మార్కులు {kra}లో ఉన్నాయి: {target}% చేరితే సుమారు {gain} పెరుగుతుంది.',
    ta: 'இந்த ஆண்டு குழுவில் நீங்கள் {of}-இல் {rank}. அடுத்த மதிப்பெண்கள் {kra}-இல் உள்ளன: {target}% அடைந்தால் சுமார் {gain} கூடும்.',
  },
  'stand.rank': {
    en: 'You are {rank} of {of} in your team this year.',
    ml: 'ഈ വർഷം ടീമിൽ നിങ്ങൾ {of}-ൽ {rank} ആണ്.',
    hi: 'इस साल टीम में आप {of} में से {rank} पर हैं।',
    te: 'ఈ సంవత్సరం టీమ్‌లో మీరు {of}లో {rank}.',
    ta: 'இந்த ஆண்டு குழுவில் நீங்கள் {of}-இல் {rank}.',
  },
  'rank.team': {
    en: 'You are {rank} of {of} in your team this year — counted against everybody who reports to your manager, the same figure as under your name on your profile.',
    ml: 'ഈ വർഷം ടീമിൽ നിങ്ങൾ {of}-ൽ {rank} ആണ് — നിങ്ങളുടെ manager-ന് റിപ്പോർട്ട് ചെയ്യുന്ന എല്ലാവരോടും താരതമ്യം ചെയ്ത്, പ്രൊഫൈലിൽ പേരിന് താഴെയുള്ള അതേ കണക്ക്.',
    hi: 'इस साल टीम में आप {of} में से {rank} पर हैं — आपके manager को रिपोर्ट करने वाले सभी लोगों में गिनकर, वही आँकड़ा जो प्रोफ़ाइल पर आपके नाम के नीचे है।',
    te: 'ఈ సంవత్సరం టీమ్‌లో మీరు {of}లో {rank} — మీ manager కి రిపోర్ట్ చేసే అందరితో పోల్చి, ప్రొఫైల్‌లో మీ పేరు కింద ఉన్న అదే సంఖ్య.',
    ta: 'இந்த ஆண்டு குழுவில் நீங்கள் {of}-இல் {rank} — உங்கள் manager க்கு அறிக்கை செய்யும் அனைவருடனும் ஒப்பிட்டு, சுயவிவரத்தில் உங்கள் பெயருக்குக் கீழே உள்ள அதே எண்.',
  },
  'rank.alone': {
    en: 'You are the only person reporting to your manager, so there is nobody in your team to rank you against.',
    ml: 'നിങ്ങളുടെ manager-ന് റിപ്പോർട്ട് ചെയ്യുന്നത് നിങ്ങൾ മാത്രമാണ്, അതിനാൽ ടീമിൽ താരതമ്യം ചെയ്യാൻ മറ്റാരുമില്ല.',
    hi: 'आपके manager को रिपोर्ट करने वाले आप अकेले हैं, इसलिए टीम में आपकी तुलना करने के लिए कोई नहीं है।',
    te: 'మీ manager కి రిపోర్ట్ చేసేది మీరు ఒక్కరే, కాబట్టి టీమ్‌లో మిమ్మల్ని పోల్చడానికి ఎవరూ లేరు.',
    ta: 'உங்கள் manager க்கு அறிக்கை செய்பவர் நீங்கள் ஒருவர் மட்டுமே, எனவே குழுவில் உங்களை ஒப்பிட யாரும் இல்லை.',
  },
  'rank.none': {
    en: 'You do not have a rank yet. It appears once a month of yours has been scored.',
    ml: 'നിങ്ങൾക്ക് ഇതുവരെ റാങ്ക് ഇല്ല. നിങ്ങളുടെ ഒരു മാസം സ്കോർ ചെയ്തുകഴിഞ്ഞാൽ അത് വരും.',
    hi: 'अभी आपकी कोई रैंक नहीं है। आपका एक महीना स्कोर होते ही यह दिखेगी।',
    te: 'మీకు ఇంకా ర్యాంక్ లేదు. మీ ఒక నెల స్కోర్ అయిన తర్వాత అది కనిపిస్తుంది.',
    ta: 'உங்களுக்கு இன்னும் தரவரிசை இல்லை. உங்கள் ஒரு மாதத்திற்கு மதிப்பெண் வழங்கப்பட்டதும் அது தோன்றும்.',
  },
  'stand.climb': {
  ...
  */
  'forecast.tooearly': {
    en: 'It is too early to say. One month cannot show how the full year will go. Ask me again after two or three more months are scored.',
    ml: 'ഇപ്പോൾ പറയാൻ നേരത്തെയാണ്. ഒരു മാസം കൊണ്ട് വർഷം മുഴുവൻ എങ്ങനെയാകും എന്ന് പറയാൻ കഴിയില്ല. രണ്ടോ മൂന്നോ മാസം കൂടി സ്കോർ ചെയ്ത ശേഷം വീണ്ടും ചോദിക്കൂ.',
    hi: 'अभी कहना जल्दबाज़ी होगी। एक महीने से पूरे साल का पता नहीं चलता। दो-तीन महीने और स्कोर होने के बाद फिर पूछिए।',
    te: 'ఇప్పుడు చెప్పడం తొందరపాటు. ఒక నెలతో సంవత్సరం మొత్తం ఎలా ఉంటుందో చెప్పలేము. మరో రెండు మూడు నెలలు స్కోరు అయ్యాక మళ్ళీ అడగండి.',
    ta: 'இப்போது சொல்வது சீக்கிரம். ஒரு மாதத்தை வைத்து ஆண்டு முழுவதும் எப்படி இருக்கும் என்று சொல்ல முடியாது. இன்னும் இரண்டு மூன்று மாதங்கள் மதிப்பிட்ட பிறகு மீண்டும் கேளுங்கள்.',
  },
  'forecast.low': {
    en: 'Only {scored} months are scored, so this is a rough guess. Your average is {soFar}. At this rate the year will end near {projected} — {band}.',
    ml: '{scored} മാസം മാത്രമേ സ്കോർ ചെയ്തിട്ടുള്ളൂ, അതിനാൽ ഇത് ഏകദേശ കണക്കാണ്. നിങ്ങളുടെ ശരാശരി {soFar}. ഈ നിലയിൽ പോയാൽ വർഷം {projected} അടുത്ത് അവസാനിക്കും — {band}.',
    hi: 'सिर्फ़ {scored} महीने स्कोर हुए हैं, इसलिए यह मोटा अनुमान है। आपका औसत {soFar} है। इसी दर से साल {projected} के आसपास खत्म होगा — {band}।',
    te: '{scored} నెలలు మాత్రమే స్కోరు అయ్యాయి, కాబట్టి ఇది సుమారు అంచనా. మీ సగటు {soFar}. ఈ రేటులో సంవత్సరం {projected} దగ్గర ముగుస్తుంది — {band}.',
    ta: '{scored} மாதங்கள் மட்டுமே மதிப்பிடப்பட்டுள்ளன, எனவே இது தோராயமான கணிப்பு. உங்கள் சராசரி {soFar}. இதே வேகத்தில் ஆண்டு {projected} அருகில் முடியும் — {band}.',
  },
  'forecast.flat': {
    en: 'Your score is steady: {soFar} over {scored} months. Keep this up for the {remaining} months left and the year will end near {projected} — {band}.',
    ml: 'നിങ്ങളുടെ സ്കോർ സ്ഥിരമാണ്: {scored} മാസത്തിൽ {soFar}. ബാക്കിയുള്ള {remaining} മാസവും ഇതുപോലെ തുടർന്നാൽ വർഷം {projected} അടുത്ത് അവസാനിക്കും — {band}.',
    hi: 'आपका स्कोर स्थिर है: {scored} महीनों में {soFar}। बाकी {remaining} महीने भी ऐसे ही रहे तो साल {projected} के आसपास खत्म होगा — {band}।',
    te: 'మీ స్కోరు స్థిరంగా ఉంది: {scored} నెలల్లో {soFar}. మిగిలిన {remaining} నెలలు ఇలాగే ఉంటే సంవత్సరం {projected} దగ్గర ముగుస్తుంది — {band}.',
    ta: 'உங்கள் மதிப்பெண் நிலையாக உள்ளது: {scored} மாதங்களில் {soFar}. மீதமுள்ள {remaining} மாதங்களும் இப்படியே இருந்தால் ஆண்டு {projected} அருகில் முடியும் — {band}.',
  },
  'forecast.up': {
    en: 'Your score is going up: {soFar} for the year, {recent} in the last few months. If this continues, the year will end near {projected} — {band}.',
    ml: 'നിങ്ങളുടെ സ്കോർ കൂടിവരുന്നു: വർഷത്തിൽ {soFar}, കഴിഞ്ഞ കുറച്ച് മാസങ്ങളിൽ {recent}. ഇതുപോലെ തുടർന്നാൽ വർഷം {projected} അടുത്ത് അവസാനിക്കും — {band}.',
    hi: 'आपका स्कोर बढ़ रहा है: साल में {soFar}, पिछले कुछ महीनों में {recent}। ऐसा ही चला तो साल {projected} के आसपास खत्म होगा — {band}।',
    te: 'మీ స్కోరు పెరుగుతోంది: సంవత్సరంలో {soFar}, గత కొన్ని నెలల్లో {recent}. ఇలాగే కొనసాగితే సంవత్సరం {projected} దగ్గర ముగుస్తుంది — {band}.',
    ta: 'உங்கள் மதிப்பெண் உயர்ந்து வருகிறது: ஆண்டில் {soFar}, கடந்த சில மாதங்களில் {recent}. இதேபோல் தொடர்ந்தால் ஆண்டு {projected} அருகில் முடியும் — {band}.',
  },
  'forecast.down': {
    en: 'Your score is going down: {soFar} for the year, but {recent} in the last few months. If this continues, the year will end near {projected} — {band}. You have {remaining} months left to improve it.',
    ml: 'നിങ്ങളുടെ സ്കോർ കുറഞ്ഞുവരുന്നു: വർഷത്തിൽ {soFar}, പക്ഷേ കഴിഞ്ഞ കുറച്ച് മാസങ്ങളിൽ {recent}. ഇതുപോലെ തുടർന്നാൽ വർഷം {projected} അടുത്ത് അവസാനിക്കും — {band}. മെച്ചപ്പെടുത്താൻ {remaining} മാസം ബാക്കിയുണ്ട്.',
    hi: 'आपका स्कोर घट रहा है: साल में {soFar}, लेकिन पिछले कुछ महीनों में {recent}। ऐसा ही चला तो साल {projected} के आसपास खत्म होगा — {band}। सुधारने के लिए {remaining} महीने बाकी हैं।',
    te: 'మీ స్కోరు తగ్గుతోంది: సంవత్సరంలో {soFar}, కానీ గత కొన్ని నెలల్లో {recent}. ఇలాగే కొనసాగితే సంవత్సరం {projected} దగ్గర ముగుస్తుంది — {band}. మెరుగుపరచడానికి {remaining} నెలలు మిగిలి ఉన్నాయి.',
    ta: 'உங்கள் மதிப்பெண் குறைந்து வருகிறது: ஆண்டில் {soFar}, ஆனால் கடந்த சில மாதங்களில் {recent}. இதேபோல் தொடர்ந்தால் ஆண்டு {projected} அருகில் முடியும் — {band}. மேம்படுத்த {remaining} மாதங்கள் உள்ளன.',
  },
  'forecast.done': {
    en: 'The year is over. {scored} months were scored, average {soFar} — {band}.',
    ml: 'വർഷം കഴിഞ്ഞു. {scored} മാസം സ്കോർ ചെയ്തു, ശരാശരി {soFar} — {band}.',
    hi: 'साल पूरा हो गया। {scored} महीने स्कोर हुए, औसत {soFar} — {band}।',
    te: 'సంవత్సరం పూర్తయింది. {scored} నెలలు స్కోరు అయ్యాయి, సగటు {soFar} — {band}.',
    ta: 'ஆண்டு முடிந்தது. {scored} மாதங்கள் மதிப்பிடப்பட்டன, சராசரி {soFar} — {band}.',
  },
  'lever': {
    en: 'Work on {kra} first. It carries {weightage}% of your score and you are getting {pct}% of that. If it reaches {target}%, your total goes up by about {gain} marks — more than any other area.',
    ml: 'ആദ്യം {kra} യിൽ ശ്രദ്ധിക്കുക. നിങ്ങളുടെ സ്കോറിൽ അതിന് {weightage}% ഭാരമുണ്ട്, അതിൽ {pct}% നിങ്ങൾ നേടുന്നു. അത് {target}% എത്തിയാൽ ആകെ സ്കോർ ഏകദേശം {gain} മാർക്ക് കൂടും — മറ്റേതിനെക്കാളും കൂടുതൽ.',
    hi: 'पहले {kra} पर काम कीजिए। आपके स्कोर में इसका भार {weightage}% है, और उसमें से आप {pct}% ले रहे हैं। यह {target}% तक पहुँचे तो कुल स्कोर लगभग {gain} अंक बढ़ेगा — किसी और हिस्से से ज़्यादा।',
    te: 'ముందుగా {kra} పై పని చేయండి. మీ స్కోరులో దీని బరువు {weightage}%, అందులో మీరు {pct}% పొందుతున్నారు. అది {target}% చేరితే మొత్తం స్కోరు సుమారు {gain} మార్కులు పెరుగుతుంది — మిగతా వాటికంటే ఎక్కువ.',
    ta: 'முதலில் {kra} இல் கவனம் செலுத்துங்கள். உங்கள் மதிப்பெண்ணில் இதன் எடை {weightage}%, அதில் {pct}% பெறுகிறீர்கள். அது {target}% அடைந்தால் மொத்த மதிப்பெண் சுமார் {gain} அதிகரிக்கும் — வேறு எந்தப் பகுதியையும் விட அதிகம்.',
  },
  'lever.none': {
    en: 'Every area is at 90% or above. There is nothing that needs fixing.',
    ml: 'എല്ലാ ഭാഗവും 90% അല്ലെങ്കിൽ അതിനു മുകളിലാണ്. ശരിയാക്കാൻ ഒന്നുമില്ല.',
    hi: 'हर हिस्सा 90% या उससे ऊपर है। सुधारने को कुछ नहीं है।',
    te: 'ప్రతి భాగం 90% లేదా అంతకంటే ఎక్కువ ఉంది. సరిచేయడానికి ఏమీ లేదు.',
    ta: 'எல்லாப் பகுதியும் 90% அல்லது அதற்கு மேல் உள்ளது. சரிசெய்ய எதுவும் இல்லை.',
  },
  'core.weakest': {
