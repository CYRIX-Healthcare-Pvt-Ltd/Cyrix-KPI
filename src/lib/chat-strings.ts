...
export const CHAT: Record<string, Phrase> = {
  ...
  */
  ...
  'tip.manual': {
    ...
    ta: 'முழு கையேடும் உங்கள் மொழியில் ஒரே பக்கத்தில் உள்ளது? ஐம்பது கேள்விகள், நேரடி பதில்கள், தொழில்நுட்பச் சொற்கள் இல்லை.',
  },
  'tip.months': {
  ...
  'tip.alternates': {
    en: 'one KPI row can measure two different things? If a month had no installations, it can count services instead — same weightage, you choose.',
    ml: 'ഒരു KPI വരിക്ക് രണ്ട് വ്യത്യസ്ത കാര്യങ്ങൾ അളക്കാനാകും? ഒരു മാസം ഇൻസ്റ്റാളേഷനുകൾ ഇല്ലെങ്കിൽ പകരം സർവീസുകൾ എണ്ണാം — അതേ weightage, നിങ്ങൾ തിരഞ്ഞെടുക്കുന്നു.',
    hi: 'एक KPI पंक्ति दो अलग चीज़ें माप सकती है? जिस महीने कोई इंस्टॉलेशन न हो, वह सर्विस गिन सकती है — weightage वही, चुनाव आपका।',
    te: 'ఒక KPI వరుస రెండు వేర్వేరు విషయాలను కొలవగలదు? ఒక నెలలో ఇన్‌స్టాలేషన్లు లేకపోతే బదులుగా సర్వీసులు లెక్కించవచ్చు — weightage అదే, ఎంపిక మీది.',
    ta: 'ஒரு KPI வரிசை இரண்டு வெவ்வேறு விஷயங்களை அளக்க முடியும்? ஒரு மாதம் நிறுவல்கள் இல்லையென்றால் சேவைகளை எண்ணலாம் — weightage அதே, தேர்வு உங்களுடையது.',
  },
  'tip.startmonth': {
