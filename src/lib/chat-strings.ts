...
export const CHAT: Record<string, Phrase> = {
  ...
  */
  ...
  'tip.videos': {
    en: 'the manual has short videos? Setting up your KPI and filling in a month — and, for managers, approving a KPI and scoring one. Each plays right there on the page.',
    ml: 'മാനുവലിൽ ചെറിയ വീഡിയോകളുണ്ട്? നിങ്ങളുടെ KPI സജ്ജമാക്കുന്നതും ഒരു മാസം പൂരിപ്പിക്കുന്നതും — മാനേജർമാർക്ക്, ഒരു KPI അംഗീകരിക്കുന്നതും സ്കോർ ചെയ്യുന്നതും. ഓരോന്നും ആ പേജിൽ തന്നെ പ്ലേ ആകും.',
    hi: 'मैनुअल में छोटे वीडियो हैं? अपना KPI सेट करना और महीना भरना — और मैनेजरों के लिए, KPI मंज़ूर करना और स्कोर करना। हर वीडियो उसी पेज पर चलता है।',
    te: 'మాన్యువల్‌లో చిన్న వీడియోలు ఉన్నాయి? మీ KPI సెట్ చేయడం, ఒక నెల నింపడం — మేనేజర్లకు, ఒక KPI ఆమోదించడం, స్కోర్ చేయడం. ప్రతిదీ ఆ పేజీలోనే ప్లే అవుతుంది.',
    ta: 'கையேட்டில் சிறிய வீடியோக்கள் உள்ளன? உங்கள் KPI ஐ அமைப்பது, ஒரு மாதத்தை நிரப்புவது — மேலாளர்களுக்கு, ஒரு KPI க்கு ஒப்புதல் அளிப்பதும் மதிப்பெண் அளிப்பதும். ஒவ்வொன்றும் அந்தப் பக்கத்திலேயே இயங்கும்.',
  },
  'video.link': {
    en: 'Watch the video',
    ml: 'വീഡിയോ കാണുക',
